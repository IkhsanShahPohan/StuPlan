...
//           <Text style={taskStyles.headerSubtitle}>{tasks.length} tugas</Text>
//         </View>
//         <TouchableOpacity
...
//               color="#C7C7CC"
//             />
//             <Text style={taskStyles.emptyText}>Belum ada tugas</Text>
...
export default function TaskListScreen() {
  ...
  const { tasks, loading, createTask, deleteTask, refreshTasks, searchTasks, filterByCategory } =
    useTasks();
  ...
  const handleCategoryFilter = (category: "all" | "tugas" | "jadwal" | "kegiatan") => {
  ...
  const getCategoryInfo = (category: string) => {
    switch(category) {
      case "tugas":
        return { label: "Tugas", icon: "briefcase", color: "#1976D2", bg: "#E3F2FD" };
      case "jadwal":
        return { label: "Jadwal", icon: "school", color: "#F57C00", bg: "#FFF3E0" };
      case "kegiatan":
        return { label: "Kegiatan", icon: "calendar", color: "#7B1FA2", bg: "#F3E5F5" };
      default:
  ...
  const hasActiveFilters = searchQuery || filterStartDate || filterEndDate || selectedCategory !== "all";
  ...
  return (
    <SafeAreaView style={taskStyles.container}>
      ...
      <View style={taskStyles.header}>
        <View>
          <Text style={taskStyles.headerTitle}>Tasks</Text>
          <Text style={taskStyles.headerSubtitle}>
            {counts[selectedCategory]} {selectedCategory === "all" ? "total" : getCategoryInfo(selectedCategory).label.toLowerCase()}
          </Text>
        </View>
        <TouchableOpacity
          style={taskStyles.filterBtn}
          ...
          <View style={taskStyles.categoryFilterRow}>
            <TouchableOpacity
              style={[
                ...
                selectedCategory === "all" && taskStyles.categoryFilterBtnActive,
              ]}
            ...
            >
              ...
              <Text
                style={[
                  ...
                  selectedCategory === "all" && taskStyles.categoryFilterTextActive,
                ]}
              >
                Semua ({counts.all})
              </Text>
            ...
            <TouchableOpacity
              style={[
                taskStyles.categoryFilterBtn,
                selectedCategory === "tugas" && taskStyles.categoryFilterBtnActive,
              ]}
            ...
            >
              ...
              <Text
                style={[
                  taskStyles.categoryFilterText,
                  selectedCategory === "tugas" && taskStyles.categoryFilterTextActive,
                ]}
              >
                Tugas ({counts.tugas})
              </Text>
            ...
            <TouchableOpacity
              style={[
                taskStyles.categoryFilterBtn,
                selectedCategory === "jadwal" && taskStyles.categoryFilterBtnActive,
              ]}
            ...
            >
              ...
              <Text
                style={[
                  taskStyles.categoryFilterText,
                  selectedCategory === "jadwal" && taskStyles.categoryFilterTextActive,
                ]}
              >
            ...
            <TouchableOpacity
              style={[
                taskStyles.categoryFilterBtn,
                selectedCategory === "kegiatan" && taskStyles.categoryFilterBtnActive,
              ]}
            ...
            >
              ...
              <Text
                style={[
                  taskStyles.categoryFilterText,
                  selectedCategory === "kegiatan" && taskStyles.categoryFilterTextActive,
                ]}
              >
      ...
      {(filterStartDate || filterEndDate) && (
        <View style={{
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <Ionicons name="filter" size={14} color="#007AFF" style={{ marginRight: 6 }} />
            <Text style={{ fontSize: 13, color: "#007AFF" }}>
              Filter tanggal aktif: {filterStartDate?.toLocaleDateString("id-ID")} - {filterEndDate?.toLocaleDateString("id-ID")}
            </Text>
          </View>
        </View>
      )}
      ...
      {/* Task List */}
      <ScrollView style={taskStyles.content} showsVerticalScrollIndicator={false}>
        {tasks.length === 0 ? (
          <View style={taskStyles.emptyState}>
            <Ionicons
              name={
                selectedCategory === "tugas" ? "briefcase-outline" :
                selectedCategory === "jadwal" ? "school-outline" :
                selectedCategory === "kegiatan" ? "calendar-outline" :
            ...
            <Text style={taskStyles.emptyText}>
              {hasActiveFilters ? "Tidak ada hasil" : `Belum ada ${selectedCategory === "all" ? "item" : getCategoryInfo(selectedCategory).label.toLowerCase()}`}
            </Text>
            <Text style={taskStyles.emptySubtext}>
              {hasActiveFilters 
              ...
              >
                ...
                <View style={taskStyles.taskFooter}>
                  <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
                    ...
                    {task.time && (
                      <View style={[taskStyles.deadlineRow, { backgroundColor: "#F0F7FF" }]}>
                        <Ionicons name="time-outline" size={14} color="#007AFF" />
                        <Text style={[taskStyles.deadlineText, { color: "#007AFF" }]}>
                          {task.time}
                        </Text>
                      </View>
                    )}
                    ...
                    {task.repeatOption && task.repeatOption !== "none" && (
                      <View style={[taskStyles.deadlineRow, { backgroundColor: "#FFF3E0" }]}>
                        <Ionicons name="repeat" size={14} color="#F57C00" />
                        <Text style={[taskStyles.deadlineText, { color: "#F57C00" }]}>
                          {task.repeatOption === "daily" ? "Harian" :
                           task.repeatOption === "weekly" ? "Mingguan" :
                           task.repeatOption === "monthly" ? "Bulanan" : "Tahunan"}
                        </Text>
                      </View>
                    )}
                  </View>
