...
import { useSubtasks, useTasks } from "../hooks/useCrud";
...
function AddTaskModal({ visible, onClose, onSubmit }: any) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (reminderEnabled) {
        // Namun, jika deadline sudah berupa objek Date atau string ISO lengkap, gunakan:
        const reminderDate = new Date(deadline);

        // 2. Kurangi hari pengingat (Ini sudah benar)
        reminderDate.setDate(reminderDate.getDate() - reminderDaysBefore);

        // 3. Set jam dan menit dari reminderTime (Ini sudah benar)
        // Asumsi: reminderTime adalah objek Date yang valid
        ...
        console.log("Reminder Days Before:", reminderDaysBefore);
        console.log("Reminder Time:", reminderTime.toLocaleTimeString("id-ID"));
        console.log(
          "Final Calculated Reminder Date (Lokal):",
          reminderDate.toLocaleString("id-ID")
        );

        // Gunakan reminderDate yang sudah dihitung sebagai waktu lokal
        if (reminderDate > new Date()) {
          notificationId = await Notifications.scheduleNotificationAsync({
            content: {
              title: "📋 Pengingat Tugas",
              body: `"${title}" akan jatuh tempo dalam ${reminderDaysBefore} hari!`,
              sound: true,
              priority: Notifications.AndroidNotificationPriority.HIGH,
            },
            trigger: {
              type: "date", // <--- Wajib ditambahkan
              date: reminderDate,
            },
          });
              ...
              {reminderEnabled && (
                <View style={styles.reminderSettings}>
                  ...
                  <View style={styles.reminderDaysRow}>
                    <TouchableOpacity
                      style={[
                        ...
                        reminderDaysBefore === 1 && styles.reminderDayBtnActive,
                      ]}
                    ...
                    <TouchableOpacity
                      style={[
                        styles.reminderDayBtn,
                        reminderDaysBefore === 3 && styles.reminderDayBtnActive,
                      ]}
                    ...
                    <TouchableOpacity
                      style={[
                        styles.reminderDayBtn,
                        reminderDaysBefore === 7 && styles.reminderDayBtnActive,
                      ]}
                  ...
                  <Text style={styles.reminderHint}>
                    💡 Pengingat akan dikirim {reminderDaysBefore} hari sebelum
                    deadline pada pukul{" "}
                    {reminderTime.toLocaleTimeString("id-ID", {
                      hour: "2-digit",
                      minute: "2-digit",
        ...
        >
          ...
          {localTask.notes && (
            <View style={styles.detailSection}>
              ...
              <Text style={styles.detailText}>{localTask.notes}</Text>
            </View>
          )}
